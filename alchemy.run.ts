...
export default Alchemy.Stack(
  ...
  Effect.gen(function* () {
    ...
    // Non-prod stages (self-host) can front the worker with their own
    // hostname; the zone is inferred from it, same as the prod domains.
    ...
    const app = yield* Cloudflare.Worker("open-seo", {
      ...
      // Other stages stay workers.dev-only unless CUSTOM_DOMAIN names a host
      // on a zone this account controls.
      domain: prod
